...
CREATE INDEX IF NOT EXISTS idx_roadmap_server ON roadmap_items(server_id);
...
CREATE INDEX IF NOT EXISTS idx_gallery_sets_creator ON gallery_sets(creator_id);

-- Images within a gallery set (ordered)
CREATE TABLE IF NOT EXISTS "gallery_set_images" (
    id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_gallery_set_images_set ON gallery_set_images(set_id);

-- Subscriptions (user subscribes to a set)
