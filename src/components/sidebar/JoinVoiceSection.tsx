...
export function JoinVoiceSection({
  ...
  // Show Create Room only if no active rooms exist, or any room has 2+ participants
  const showCreateBtn = voiceWithUsers.length === 0
    || voiceWithUsers.some((r) => r.participants.length >= 2);
